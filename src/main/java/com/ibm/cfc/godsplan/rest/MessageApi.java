...
public class MessageApi extends HttpServlet
{
	...
	private QueryResponse confirmResponse(String smsTxtBody, String userPhoneNumber, CloudantPersistence metadata,
			Optional<String> mediaURI, String watsonResponse, ResponsePosition position)
	{
