...
public class CloudantPersistence {
	...
	public CloudantPersistence()
	{
		CloudantClient client = 
				ClientBuilder
				.account("c008a85f-96b2-4d29-98c7-eedff0e86b1f-bluemix")
	...
	{
		ChatContext chatContext = chatContextDb.find(ChatContext.class, phoneNumber);
		Optional<ChatContext> optional = Optional.of(chatContext);
		return optional;
	}
